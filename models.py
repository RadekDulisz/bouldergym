...
class Pass(db.Model):
    ...
    entries_total = db.Column(db.Integer, nullable=True)
    entries_remaining = db.Column(db.Integer, nullable=True)
...
class Shoes(db.Model):
    ...
    current_renter = db.relationship('User', foreign_keys=[current_renter_id])
